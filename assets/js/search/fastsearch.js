...
Updated March 2025 - allow searching content from posts.
...
const DEFAULT_CONFIG = {
    ...
    search: {
        ...
        fields: {                 // Fields to search through
            ...
            content: true           // Allow searching content
        }
    }
};
    ...
    async function loadSearchIndex() {
        try {
            ...
            searchIndex = data.map(item => ({
                ...
                searchableContent: item.contents?.toLowerCase() || ''
            }));
                ...
                const matchesAllTerms = searchTerms.every(term => {
                    ...
                    if (!matched) {
                        if (CONFIG.search.fields.content && item.searchableContent.includes(term)) {
                            score += 0.8;  // Lower score for content matches
                            matched = true;
                        }
